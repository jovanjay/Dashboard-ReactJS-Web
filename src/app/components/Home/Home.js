...
class Home extends React.Component {
    ...
    modalContent = () => {
        return (<>
            <Row>
                <Col lg={12} className="pr-4 pl-4 pb-4">
                    <p>
                        <strong>Fuze</strong> is a Front-End Framework project using <strong>ReactJS Components + Redux</strong>. It provide an easy way to implement an application interface that can be deployed via <strong>Web</strong> or as a <strong>Desktop Application</strong> using <strong>ElectronJS</strong>. It comes with a basic reusable element such us data driven forms, tables, charts &amp; Layouts. Its using <strong>React-Bootstrap</strong> as its main styled layout components.
                    </p><br/>
        ...
        return (<div>
                ...
                <Row>
                    <Col lg={7} md={6} sm={12} className="mb-3">
                        <Card bg="default" text="white" className="stats-panel stats-panel-row-first">
                        ...
                        <Row>
                            {this.state.stats.map((item, index) => (                        
                                <Col key={index} lg={6} md={12} sm={12} className="mb-3">
                                    <Card key={index} bg="default" className="stats-panel mb-3">
                                        <Card.Body className="row">
                                            <Col lg={6} md={6} sm={6}>
                                                <p><strong>{item.label}</strong></p>
                                                <p className="font-sans-serif lh-1 mb-10 fs-4">{item.value}</p>
                                                <Badge pill variant={item.bg}>+2.3%</Badge>
                                            </Col>
                ...
                <Row className="mb-3">
                    ...
                    <Col lg={5} md={6} sm={12} className="mb-3 stats-panel stats-panel-row-first">
                        <Card lg={5} md={6} sm={12} bg="default" text="white" className="cardstats-panel stats-panel-row-first">
                ...
                <Row className="mb-3">
                    ...
                    <Col lg={4} md={12} sm={12} className="mb-3">
                        <Card bg="default" className="stats-panel stats-panel-row-first">
                            <Card.Header>
                                <strong>Running Projects</strong>
                            </Card.Header>
                            <ListGroup>
                                <ListGroup.Item><Bathtub className="float-left mr-3"/> Cras justo odio</ListGroup.Item>
                                <ListGroup.Item><Assistant className="float-left mr-3"/> Dapibus ac facilisis in</ListGroup.Item>
                                <ListGroup.Item><AttachFile className="float-left mr-3"/> Morbi leo risus</ListGroup.Item>
                                <ListGroup.Item><BugReport className="float-left mr-3"/> Porta ac consectetur ac</ListGroup.Item>
                                <ListGroup.Item><Extension className="float-left mr-3"/> Vestibulum at eros</ListGroup.Item>
                                <ListGroup.Item><Face className="float-left mr-3"/> Vestibulum at eros</ListGroup.Item>
                                <ListGroup.Item><Fingerprint className="float-left mr-3"/> Vestibulum at eros</ListGroup.Item>
                            </ListGroup>
