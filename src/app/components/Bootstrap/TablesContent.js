...
class TablesContent extends React.Component {
    ...
    tableContent = (row_count) => {
        ...
        var rows = [];
        var data = MockData.PersonData(row_count);
        ...
        return (<Table striped responsive hover className="mb-0">
                <thead>
                    <tr>
                        <th>First Name</th>
                        <th>Last Name</th>
        ...
        return (
                ...
                <Col>
                    ...
                    <Card bg="default" className="stats-panel stats-panel-row-first">
                        <Table responsive hover size="md" as="Card.Body" className="mb-0">
                            <thead ><tr><td colSpan="6">Light Theme <a className="float-right" onClick={() => {}}><Info/></a></td></tr></thead>
                            <thead>
                                <tr>
                                    <th>First Name</th>
                                    <th>Last Name</th>
                ...
                <Col>
                    ...
                    <Card bg="default" className="stats-panel stats-panel-row-first">
                        <Table striped bordered responsive hover size="md" variant="dark" as="Card.Body" className="mb-0">
                            <thead ><tr><td colSpan="6">Dark Theme <a className="float-right" onClick={() => {}}><Cancel fontSize="small"/></a><a className="float-right mr-1" onClick={() => {}}><OpenInNew fontSize="small"/></a></td></tr></thead>
                            <thead>
                                <tr>
                                    <th>First Name</th>
                                    <th>Last Name</th>
            ...
            <Row className="mb-3">
                <Col className="mt-3 mb-3 tabbed-tables" lg={12}>
                    ...
                    <Tab.Container id="left-tabs-example" defaultActiveKey="tab_2">
                        <Card>
                            <Card.Header>
                                <Nav variant="tabs">
    ...
    menuItems : [
            ...
            subMenu : [
                {
                    label : 'Mixins',
                    component : appComponents.TABLES,
                    parent : appComponents.TABLES
                },
                {
                    label : 'Pagination',
                    component : appComponents.TABLES_PAGINATION,
                    parent : appComponents.TABLES
                }
            ]
        },
        {
            ...
            subMenu : [
                {
                    label : 'Actions',
                    component : appComponents.TABLES_ACTIONS,
                    parent : appComponents.TABLES
                },
                {
                    label : 'Context Menu',
